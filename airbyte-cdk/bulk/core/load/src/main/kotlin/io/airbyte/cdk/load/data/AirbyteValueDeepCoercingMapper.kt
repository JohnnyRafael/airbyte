 ...
 * mapper that returns non-native-JSON types (date, timestamp, etc.).
 *
 * If this mapper is included in a [MapperPipeline], it SHOULD be preceded by
 * [SchemalessTypesToStringType] / [SchemalessValuesToJsonString] and [MergeUnions] mappers. Not
 * including those mappers may result in strange behavior when coercing union and schemaless types.
 *
